namespace Game.Core.DotLua
{
    ...
    public static class LuaAPI
    {
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        public static extern void lua_pushulong(IntPtr L, ulong v);
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
#if UNITY_IPHONE
		public static extern IntPtr lua_tolstring(IntPtr L, int idx, ref long len);
#else
        ...
        [DllImport(DllName, CallingConvention=CallingConvention.Cdecl)]
        public static extern ulong lua_toulong(IntPtr L, int idx);
        [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
        ...
        public delegate int lua_Hook(IntPtr L, IntPtr Debugger);
